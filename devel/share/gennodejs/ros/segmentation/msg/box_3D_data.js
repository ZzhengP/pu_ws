...
class box_3D_data {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type box_3D_data
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type box_3D_data
    let len;
    let data = new box_3D_data(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new box_3D_data(null);
